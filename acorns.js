...
function acornCollision ()
{

  for (var i=0; i< GAME.acorns.length; i++){
  var acornX = GAME.acorns[i].x;
  var acornY = GAME.acorns[i].y;
  if ((GAME.players[0].x-20 <= acornX+20 && acornX+20 <= GAME.players[0].x + 20) && (GAME.players[0].y-120 <= acornY+20 && acornY+20 <= GAME.players[0].y-5))
  {

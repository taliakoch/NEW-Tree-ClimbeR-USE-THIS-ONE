...
function runGame() {
  ...
  if(GAME.started) {
    ...
    context.fillText("Final Score: " + distance, 130, 100);
    context.fillText("Final Apple Count: " + appleScore, 80, 150);
    context.fillStyle='red';
    context.drawImage (image3, 150, 160, 200, 400);
    context.fillText("You suck.", 150, 200);
    context.fillText("Try harder.", 145, 300);
    context.fillText("College is just a dream for you.", 20, 400);
  }
